    ...
    <div class="box">
                        ...
                        >
                            <b-form inline v-on:submit.prevent class="flex">
                                <b-form-input
                                    ...
                                    maxlength="32"
                                ></b-form-input>
                                <button class="ml-1 btn btn-primary" v-on:click="addItem">Add</button>
                            </b-form>
                        </b-form-group>
                    </b-form-group>
                </b-card>
                    ...
                    >
                        ...
                        <b-list-group-item class="flex py-2 px-3">
                            <b-form-checkbox
                                ...
                                size="lg"
                                v-model="todo.status"
                            >{{ index }}: {{ todo.item }}</b-form-checkbox>
                            <b-button
        ...
        <Modal @close="closeModal" v-if="modal">
            ...
            <template slot="footer">
                <b-button class variant="info" size="sm" @click="closeModal()">キャンセル</b-button>
                <b-button class variant="danger" size="sm" @click="doDelItem(index)">送信</b-button>
            </template>
        </Modal>
        ...
        <Modal @close="closeModal_delAll" v-if="modal_delAll">
            ...
            <template slot="footer">
                <b-button class variant="info" size="sm" @click="closeModal_delAll()">キャンセル</b-button>
                <b-button class variant="danger" size="sm" @click="doDelItem_delAll(index)">送信</b-button>
            </template>
        </Modal>
    </div>
</template>
